import type { MaybeClassName, MaybeId } from "~/components";
import type { DialogProps } from "@mui/material/Dialog";
import type { ButtonProps } from "@mui/material/Button";

export interface ModalProps extends DialogProps, MaybeClassName {
  id: string;
  open: boolean;
  /**
...
export interface ModalHeaderProps extends MaybeId {
  /** Callback to invoke when the modal is closed */
  onClose?: () => void;
}
